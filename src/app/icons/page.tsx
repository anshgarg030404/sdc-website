...
const SocialMediaTransition: React.FC = () => {
  ...
  return (
    <>
      <div className="relative w-fit h-12 space-y-3">
        <h1 className="uppercase">Follow us</h1>
        <button
          onClick={handleToggle}
          className={`absolute  align-top  z-10  text-7xl text-white  transition-transform duration-500 ease-in-out ${
          ...
          <a href="#" className="p-1 bg-white rounded-2xl  ">
            <div className="group transition-all  ease-in-out  ">
              <Image
                ...
                src={Insta_1}
                alt="Insta"
                className={`size-10 group-hover:hidden rounded-lg   `}
              />
              <Image
                priority
                src={Insta_2}
                alt="Insta"
                className={`size-10 group-hover:block hidden rounded-lg `}
              />
            </div>
          </a>
          <a href="#" className="p-1 bg-white rounded-2xl  ">
